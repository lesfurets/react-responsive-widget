...
class App extends React.Component {
    ...
    handleOnChange(event) {
        this.setState({
            ...
            currentBreakpoint: App.getCurrentBreakpoint(event.target.value)
        }, () => window.dispatchEvent(new Event('resize')))
    }

    static getCurrentBreakpoint(width) {
        if (width >= XL.value) {
            return XL.label;
            ...
            <div className="Demo">
                <div className="Demo-slider">
                    ...
                    <div className="Demo-currentBreakpoint">
                        Current breakpoint is <strong>{this.state.currentBreakpoint}</strong> ({this.state.width}px)
                        </div>
                </div>
                <div className={"Demo-container"} style={{width: this.state.width + 'px'}}>
                    <ResponsiveContainer>

                        <div className="Demo-item grid doc">
                            <div className="Demo-title">Doc</div>
                            <hr/>
